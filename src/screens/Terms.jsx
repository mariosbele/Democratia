  ...
  return (
    <div className="flex h-full flex-col overflow-y-auto no-scrollbar bg-white">
      ...
      <div className="flex-1 space-y-5 px-6 pb-10 pt-2 text-sm leading-relaxed text-slate-700">
        ...
        <Section title="Η ψήφος σας είναι ανώνυμη (όπως στις εθνικές εκλογές)">
          Καταγράφουμε ξεχωριστά <strong>ότι</strong> ψηφίσατε (για να μετράει η
          συμμετοχή και να μην ψηφίζει κανείς δύο φορές) και, εντελώς χωριστά,
          <strong> τι</strong> ψηφίστηκε. Τα δύο <strong>δεν συνδέονται</strong>:
          ακόμη κι αν κάποιος αποκτούσε πρόσβαση στη βάση, δεν θα μπορούσε να δει
          τι ψηφίσατε εσείς. Είναι σαν την κάλπη και τον εκλογικό κατάλογο.
        </Section>

        <Section title="Το όνομά σας στην κοινότητα">
          Το ονοματεπώνυμό σας εμφανίζεται <strong>μόνο</strong> στα σχόλια που
          γράφετε δημόσια στην κοινότητα — ώστε να αναδεικνύονται πρόσωπα με άποψη
          και να ενισχύεται ο δημόσιος διάλογος. Δεν εμφανίζεται ποτέ δίπλα σε ψήφο,
          και κανένα άλλο προσωπικό σας στοιχείο (ΑΦΜ, τηλέφωνο) δεν είναι ορατό ή
          αποθηκευμένο.
        </Section>

        <Section title="Ταυτοποίηση & ασφάλεια">
          Η σύνδεση γίνεται απευθείας μέσω Taxisnet (gov.gr) — η διπλή ταυτοποίηση γίνεται από την
          κρατική υπηρεσία. Οι συνεδρίες λήγουν αυτόματα και μπορείτε να αποσυνδεθείτε ανά πάσα στιγμή.
        </Section>
