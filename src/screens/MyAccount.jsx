...
export function MyAccount() {
  ...
  async function handleDelete() {
    if (!confirm(
      ...
      'Θα αφαιρεθούν: το ονοματεπώνυμό σας, το hash ΑΦΜ, τυχόν επώνυμα σχόλια.\n\n' +
      'ΔΕΝ αφαιρούνται οι ψήφοι σας — είναι ανώνυμες και έχουν ήδη συμπεριληφθεί στα αποτελέσματα.\n\n' +
